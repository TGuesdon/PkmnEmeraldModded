...
#define FLAG_ITEM_QUAGSIRE_CAVE_DUBIOUS_DISC                        0x493 // Unused Flag
#define FLAG_ITEM_POKEBALL_ROUTE_103                                           0x494 // Unused Flag
...
#define FLAG_LANDMARK_PETALBURG_BEACH               (SYSTEM_FLAGS + 0x83) // Unused Flag
