...
static const u8 LandmarkName_PetalburgBeach[] = _("PETALBURG BEACH");
...
static const struct Landmark Landmark_PetalburgBeach = {LandmarkName_PetalburgBeach, FLAG_LANDMARK_PETALBURG_BEACH};
...
static const struct Landmark *const Landmarks_PetalburgBeach[]  =
{
    &Landmark_PetalburgBeach,
    NULL,
};
...
static const struct LandmarkList sLandmarkLists[] =
{
    ...
    {MAPSEC_PETALBURG_BEACH, 0, Landmarks_PetalburgBeach},
    {MAPSEC_NONE, 0, NULL},
};
